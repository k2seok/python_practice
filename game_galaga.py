...
class Enemy():
    def __init__(self, canvas, x, y):
        ...
        self.x = x;
        self.y = y;
        self.me = self.canvas.create_image(self.x, self.y, image=PhotoImage(file="image/bullet.png"))
        pass;
...
class App:
    ...
    def makeEnemy(self, cnt):
        self.enemyCount = cnt;

        # TODO for loop make enemy
        self.enemies.append(Enemy(self.canvas, 50, 50));
